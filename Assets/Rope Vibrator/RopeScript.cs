...
public class RopeScript : MonoBehaviour {
	...
	*/
	...
	public float lowTwistLimit = -0F;					//  The lower limit around the primary axis of the character joint. 
	public float highTwistLimit = 0F;					//  The upper limit around the primary axis of the character joint.
	...
	private float _vibIntensity = 50f;
	public float vibIntensity{
		...
		set {
			...
			{
				joints[i].GetComponent<VibrationScript>().intensity = value;
			}
		}
	}
	private int _vibRate = 1;
	public int vibRate{
		get {
			return _vibRate;
		}
	...
	void AddJointPhysics(int n)
	{
		...
		if ((n != 0 || n != joints.Length - 1) && n%4 == 0 ) {
			VibrationScript vib = joints[n].AddComponent<VibrationScript>();
			vib.intensity = vibIntensity;
			vib.rate = vibRate;
		}
